from utils2 import PPO_Actor, V_Critic,PPO_ReplayBuffer
...
class PPO_agent(object):
	def __init__(self, **kwargs):
		...
		self.replay_buffer = PPO_ReplayBuffer(self.state_size1,self.his_length,self.action_size,self.num_envs,self.max_steps,self.device)
		if self.abs:
