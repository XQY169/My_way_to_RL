...
if __name__ == '__main__':
    ...
    kwargs_TR = {'port':6006,'log_dir':'./runs/experiment9','save_model_path':'./models/test_model4/',
                 'save_training_data_path':'./Training_data/test_model4.csv','window_size':50,'tb_allow':True}
