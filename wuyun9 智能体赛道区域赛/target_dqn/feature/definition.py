...
def reward_shaping(
    frame_no, score, terminated, truncated, obs, _obs, env_info, _env_info,epoch
):
    reward = 0
    # print('epoch:',epoch,'frame_no',frame_no)
    ...
    # prev_treasure_dists.append(prev_buff_dist)
    # treasure_dists.append(buff_dist)
    ...
    pre_min_treasure = min(prev_treasure_dists)
    pre_min_index = prev_treasure_dists.index(pre_min_treasure)
    if treasure_dists[pre_min_index] < pre_min_treasure:
        reward_treasure_dist = 1
    # 奖励2.1 向宝箱靠近的奖励(只考虑最近的那个宝箱)
    # print(pre_min_treasure,pre_min_index,prev_treasure_dists)
    ...
    # print(memory_map[1300])
    if memory_map[1300] >= 0.9:
        reward_memory = -1
    else:
        reward_memory = 0
    ...
    num_none_found_treasure = 15.0 - treasure_dists.count(1.0)
    REWARD_CONFIG = {
            "reward_end_dist": "0",
            "reward_win": "5",
            "reward_buff_dist": "1",
    ...
    if treasure_dists.count(1.0) == 15:
        REWARD_CONFIG['reward_end_dist'] = 1 
    # if epoch <= 100:
    #     REWARD_CONFIG = {
    #         "reward_end_dist": "1",
    #         "reward_win": "7",
    ...
    #     REWARD_CONFIG = {
    #         "reward_end_dist": "0",
    #         "reward_win": f"{-num_none_found_treasure*0.2}",
    #         "reward_buff_dist": "1",
    #         "reward_buff": "1",
    #         "reward_treasure_dists": "1",
    #         "reward_treasure": "1",
    ...
    #         "reward_memory": "1",
    #     }
    #     if treasure_dists.count(1.0) >= 13:
    #         REWARD_CONFIG['reward_end_dist'] = 1
    #         REWARD_CONFIG['reward_step'] = -1   
    #         REWARD_CONFIG['reward_win'] = 1 
    #         REWARD_CONFIG['reward_memory'] = 0.5
    # num_none_found_treasure = 15.0 - treasure_dists.count(1.0)   
    # REWARD_CONFIG = {
    #         "reward_end_dist": "0",
    #         "reward_win": f"{-num_none_found_treasure}",
    #         "reward_buff_dist": "1",
    #         "reward_buff": "1",
    #         "reward_treasure_dists": "1",
    #         "reward_treasure": "1",
    ...
    #         "reward_memory": "0",
    # }
    # if treasure_dists.count(1.0) >= 14:
    #     REWARD_CONFIG['reward_end_dist'] = 1
    #     REWARD_CONFIG['reward_step'] = -1   
    #     REWARD_CONFIG['reward_win'] = 1  
    """
...
def observation_process(raw_obs, env_info=None):
    ...
    # print(buff_pos_features)
    end_pos_features = read_relative_position(end_pos)
    start_pos_features = read_relative_position(start_pos)
    end_pos_len = len(end_pos_features)
    start_pos_len = len(start_pos_features)
    ...
    treasure_poss_features[0:end_pos_len] = end_pos_features
    treasure_poss_features[end_pos_len:end_pos_len+start_pos_len] = start_pos_features
