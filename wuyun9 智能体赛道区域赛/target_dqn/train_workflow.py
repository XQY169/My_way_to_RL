...
def workflow(envs, agents, logger=None, monitor=None):
    ...
    for epoch in range(epoch_num):
        epoch_total_rew = 0
        data_length = 0
        for g_data in run_episodes(episode_num_every_epoch, env, agent, g_data_truncat, usr_conf, logger,epoch):
...
def run_episodes(n_episode, env, agent, g_data_truncat, usr_conf, logger,epoch):
